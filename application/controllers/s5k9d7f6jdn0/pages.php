...
class Pages extends CI_Controller
{
    ...
    function __construct() {
        ...
        $this->breadcrumbs[] = array('name' => "Pages", 'url' => '/s5k9d7f6jdn0/pages/');
    }

    public function index()
    {
        $this->erkana_auth->required();
        $this->breadcrumbs[] = array('name' => "View", 'url' => '/s5k9d7f6jdn0/pages/');

        $page = $this->getPageData();

        $page['title'] = 'Pages';
        $page['pages'] = $this->admin_model->get_pages();
        $page['content'] = $this->load->view('admin/pages', $page, true);
