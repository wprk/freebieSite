            ...
            <?php if($expired) { ?>
                ...
                <footer>
                    <div class="submit_link">
                        ...
                        <a href="/admin/edit/listings/<?php echo $expired['listing_id'];?>">
                        ...
                        <a class="delete_action" href="/admin/action/delete/listing/<?php echo $expired['listing_id'];?>">
        ...
        <div id="oldest" class="tab_content">
            ...
            <footer>
                <div class="submit_link">
                    ...
                    <a href="/admin/edit/listings/<?php echo $oldest['listing_id'];?>">
                        <input type="submit" value="Edit" class="alt_btn">
                    </a>
                    <form action="/admin/edit/listings/<?php echo $oldest['listing_id']; ?>/" autocomplete="on" method="post">
                        <input name="listing_title" value="<?php echo $oldest['listing_title']; ?>" type="hidden">
                    ...
                    <a class="delete_action" href="/admin/action/delete/listing/<?php echo $oldest['listing_id'];?>">
                        <input type="submit" value="Delete">
                    </a>
                </div>
                <div class="goto_link">
